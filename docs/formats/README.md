...
| Pattern width | recovered from the cell stream | stated in the header | named by the tag | stated in the channel table | the four the machine played |
...
row where a stream lists only what plays, and one byte a cell — four in the Amiga lineage — where a grid
