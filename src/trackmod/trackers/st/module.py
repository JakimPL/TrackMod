...
class STModule(BaseModel, Reaching):
    ...
    def parse(
        ...
        *,
        ...
        """Read a module from the bytes of a fifteen-sample Soundtracker file.
        ...
        Raises:
        ValueError: when the data stops inside a record. This format carries no tag, so the bytes
            are read as the fifteen-sample layout whatever they hold.
    ...
    def load(
        ...
        *,
        ...
        """Open a fifteen-sample Soundtracker file and read the module inside it.
