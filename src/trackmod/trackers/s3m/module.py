...
from trackmod.trackers.s3m.writer import write_module


class S3MModule(BaseModel):
    ...
    def parse(
        ...
        *,
        ...
        """Rebuild a module from the bytes of a Scream Tracker 3 file.

        Raises:
            ValueError: when the data opens with another format's tag, or holds an instrument record
                describing an OPL patch rather than a waveform.
        """
    ...
    def load(
        ...
        *,
        ...
        """Read a module from a Scream Tracker 3 file."""
