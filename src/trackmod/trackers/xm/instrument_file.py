...
class XMInstrumentFile(BaseModel, Reaching):
    """A standalone FastTracker 2 instrument, written as an ``.xi`` file.
    ...
    def parse(
        ...
        *,
        ...
        """Read one instrument from the bytes of a FastTracker 2 ``.xi`` file.
        ...
        Raises:
        ValueError: when the data does not open with this format's instrument tag, or stops
            inside a record.
    ...
    def load(
        ...
        *,
        ...
        """Open a FastTracker 2 ``.xi`` file and read the instrument inside it.
