...
VOLUME_COLUMN: Final = VolumeColumn(
    ...
    spans=(
        VolumeSpan(
            effect=VolumeEffect.VOLUME_SLIDE_DOWN,
            base=0x60,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(
            effect=VolumeEffect.VOLUME_SLIDE_UP,
            base=0x70,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(
            effect=VolumeEffect.FINE_VOLUME_DOWN,
            base=0x80,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(
            effect=VolumeEffect.FINE_VOLUME_UP,
            base=0x90,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(
            effect=VolumeEffect.VIBRATO_SPEED,
            base=0xA0,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(
            effect=VolumeEffect.VIBRATO_DEPTH,
            base=0xB0,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(effect=VolumeEffect.PANNING, base=0xC0, amounts=PANNING_AMOUNTS),
        VolumeSpan(
            effect=VolumeEffect.PANNING_SLIDE_LEFT,
            base=0xD0,
            amounts=COMMAND_AMOUNTS,
        ),
        VolumeSpan(
            effect=VolumeEffect.PANNING_SLIDE_RIGHT,
            base=0xE0,
            amounts=COMMAND_AMOUNTS,
        ),
